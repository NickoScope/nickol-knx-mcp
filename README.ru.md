...
реконструкция реального as-built проекта ETS на 14 комнат из одного только 42-страничного ТЗ дала
**96 % структурного совпадения** (662 против 687 GA), таксономию доменов 10 / 10, при **нуле ошибок
валидации** — подробный разбор в **[кейсе](docs/case-study.ru.md)**. Оставшаяся дельта — это
параметризация устройств интегратором, которой в ТЗ просто нет.
